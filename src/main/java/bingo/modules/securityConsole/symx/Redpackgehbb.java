...
public class Redpackgehbb extends BaseObject{
	...
	public String getHbllfk() {
		return hbllfk;
	}
	public void setHbllfk(String hbllfk) {
		this.hbllfk = hbllfk;
	}
	public Integer getHbb() {
		return hbb;
	}
	public void setHbb(Integer hbb) {
		this.hbb = hbb;
	}
	...
	public float getCrje() {
		return crje;
	}
	public void setCrje(float crje) {
		this.crje = crje;
	}
