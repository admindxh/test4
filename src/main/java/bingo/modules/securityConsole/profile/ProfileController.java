...
public class ProfileController {
	...
	public void createProfile() {
		...
		Result.forward("/modules/profile/edit_sys_profile.jsp");
	}
	...
	public void createProfileParameter(String profileId) {
		...
		Result.forward("/modules/profile/edit_sys_profile_param.jsp");
	}
	...
	public void copyProfile(String profileId) {
		...
		Result.forward("/modules/profile/select_sys_profile.jsp");
	}
