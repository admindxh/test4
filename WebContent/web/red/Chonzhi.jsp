...
<body>
	...
	<div class="container transfer-info mt20">
		<p><span>&nbsp;&nbsp;账号：</span><input type="text" id="userjhm" name="userjhm" onblur="checks(this.value);" value="${hbdXuser.userjhm }"></p>
	</div>
		...
		<div class="clearfix">
			...
			<div class="num-cover">
				<em class="action action-cut aCut"></em>
					<input type="text" id="hbb" class="num" name="aggreatMount">
	...
	<div class="container mt20">
		<a href="#" class="btn green-btn" onClick="mychongzhi()">确认</a>
	</div>
	</form>
	<script>
