var dataServiceUrl = "http://{host}:{port}/bingoui-demo-serivces/dataservice";
var serviceContext = "http://{host}:{port}/bingoui-demo-serivces" ;
...
$(function(){
	...
	if($.fn.tabs && $(".view-source")[0]){
		...
		tabs.tabs( {
			tabs:[
				{label:'overview',id:"tab-overview",url:"http://developer.bingosoft.net/wiki/ui/"+_type+":"+pluginName+":overview?embed=true&parentcontext="+currentDomain,iframe:true,selected:true},
				{label:'view source',content:'vs-source'},
				{label:'options',id:"tab-options",url:"http://developer.bingosoft.net/wiki/ui/base:"+pluginName+":options?embed=true&parentcontext="+currentDomain,iframe:true},
				{label:'event',id:"tab-event",url:"http://developer.bingosoft.net/wiki/ui/base:"+pluginName+":event?embed=true&parentcontext="+currentDomain,iframe:true},
				{label:'method ',id:"tab-method",url:"http://developer.bingosoft.net/wiki/ui/base:"+pluginName+":method?embed=true&parentcontext="+currentDomain,iframe:true},
				{label:'FAQ',id:"tab-faq",url:"http://developer.bingosoft.net/wiki/ui/base:"+pluginName+":faq?embed=true&parentcontext="+currentDomain,iframe:true}
			],
			height:"1000px",
