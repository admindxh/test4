...
<head>
    ...
    <ui:combine widgets="tree,layout,dialog,contextmenu"></ui:combine>
    <ui:script src="/modules/user/script/list_sec_user_main.js"></ui:script>
</head>

<body class="mainarea">
	<div data-widget="layout" style="width:100%;height:100%">
		<div region="west" split="true" title="组织机构" style="width:170px;">
            	<div id="treeDiv" oncontextmenu="return false;">
				</div>
		</div>
