...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<ui:script src="modules/profile/script/select_sys_profile.js"></ui:script>
		<script>
					...
					<div class="panel apply-panel">
						...
						<div class="panel-content">
							...
							<dg:grid container="profile_div" id="profile_select_grid" onRowClick="doOnRowSelected" onCellCheck="doOnCheck">
								<dg:datasource selectSqlId="profile.getProfiles" includePageParams="true"></dg:datasource>
