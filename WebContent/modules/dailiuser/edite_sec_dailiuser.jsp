					...
					<div class="panel-content">
						...
						<table class="form-table col4-fluid" >
							...
							<tbody>
				               ...
				               <TR>
								     <th>红包日收益：</th>
								   <td><input type="text" id="aggreatMount" data-validator="required" readonly="readonly" onblur="addsaveputong()" maxlength="20"   style="width: 330px;" class="input-large" value="<%=request.getAttribute("number")%>"/>
									</td>
								  </TR>
								  <TR>
								    <th>红包总收益：</th>
