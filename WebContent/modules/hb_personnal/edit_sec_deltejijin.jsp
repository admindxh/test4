	...
	<head>
		...
		<script type="text/javascript">
			function addsaveputong(){
			        ...
			        var n=document.getElementById("ketimoney").value;
				...
				<div class="panel apply-panel">
					...
					<div class="panel-content">
						...
						<table class="form-table col4-fluid" >
							...
							<tbody>
				               ...
				               <TR>
								     <th>红包基金日收益：</th>
								   <td><input type="text" id="ketimoney"  name="ketimoney" data-validator="required" readonly="readonly" onblur="addsaveputong()" maxlength="20"   style="width: 330px;" class="input-large" value="<%=request.getAttribute("number")%>"/>
									</td>
								  </TR>
								  <TR>
								    <th>红包基金总收益：</th>
									<td>
									<input type="text" id="aggreatMount" name="aggreatMount" data-validator="required"  maxlength="20"  onblur="addsaveputong()" style="width: 330px;" class="input-large" value="<%=request.getAttribute("sum")%>"/>
                    ...
                    <div class="panel-foot">
						<div class="form-actions col4-fluid">
							<button type="button" class="btn" onclick="doSavehbjj();return false;"><i class="icon-save"></i>提&nbsp;取</button>
